                    ...
                    child: Align(
                      ...
                      child: Column(
                        children: [
                            ...
                            return Container(
                              ...
                              child: ClipOval(
                                child: CachedNetworkImage(
                                  ...
                                  height: 100,
                                  fit: BoxFit.cover,
                                  imageUrl: controller1.model.value
                                      .data!.profileImage
                                      .toString(),
                          ...
                          Text(controller1.model.value.data!.name
                              .toString(),
                          ...
                          FittedBox(
                            child: Text(
                                controller1.model.value.data!.email
                                    .toString(),
                                style: GoogleFonts.poppins(
                                  fontSize: 15,
                                  color: const Color(0xFFFFFFFF),
          ...
          children: [
            InkWell(
              ...
              child: Padding(
                ...
                child: Image.asset(
                  'assets/images/menu_left_icon.png', height: 24,),
              ),
            ),
          ],
        ),
        ...
        SingleChildScrollView(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text('Hi, ${controller.model.value.data!.username.toString()}',
